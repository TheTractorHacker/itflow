...
<div class="modal-body">
    ...
    <div>
        ...
        <ul class="ps-3 mb-2">
            ...
            ?>
            <li><a href="/uploads/mail_requests/<?= $mail_request_id ?>/<?= rawurlencode($att['mail_request_attachment_reference_name']) ?>" target="_blank"><?= nullable_htmlentities($att['mail_request_attachment_name']) ?></a></li>
            <?php } ?>
        </ul>
