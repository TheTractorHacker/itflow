...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-list me-2"></i>Set Category: <strong><?= $count ?></strong> Expense<?= $count == 1 ? '' : 's' ?></h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="bulk_edit_expense_category" class="btn btn-primary text-bold"><i class="fa fa-fw fa-check me-2"></i>Set</button>
