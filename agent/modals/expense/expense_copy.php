...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class='fas fa-fw fa-copy me-2'></i>Copying expense</h5>
...
<form action="post.php" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="add_expense" class="btn btn-primary text-bold"><i class="fa fa-check me-2"></i>Copy</button>
