...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-download me-2"></i>Exporting Expenses to CSV</h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="export_expenses_csv" class="btn btn-primary text-bold"><i class="fas fa-fw fa-download me-2"></i>Download CSV</button>
