...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-wallet me-2"></i><?php echo "$invoice_prefix$invoice_number"; ?>: Apply Credit (Balance: <?php echo numfmt_format_currency($currency_format, $credit_balance, $session_company_currency); ?>)</h5>
