...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-book mr-2"></i>New Knowledge Base Article</h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="title" maxlength="255" placeholder="Article title" required autofocus>
            </div>
        </div>
    ...
    <div class="modal-footer">
        <button type="submit" name="add_kb_article" class="btn btn-primary text-bold"><i class="fa fa-check mr-2"></i>Create Article</button>
