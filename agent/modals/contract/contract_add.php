            ...
            <div class="row">
                <div class="col">
                    <div class="input-group">
                        ...
                        <input type="number" min="0" step="0.25" class="form-control" name="support_hours_included_remote" placeholder="Remote hrs / mo">
                    </div>
                </div>
                <div class="col">
                    <div class="input-group">
                        ...
                        <input type="number" min="0" step="0.25" class="form-control" name="support_hours_included_onsite" placeholder="Onsite hrs / mo">
                    </div>
                </div>
            </div>
        </div>
