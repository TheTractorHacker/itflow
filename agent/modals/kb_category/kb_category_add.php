...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-folder mr-2"></i>New Knowledge Base Category</h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="add_kb_category" class="btn btn-primary text-bold"><i class="fa fa-check mr-2"></i>Create Category</button>
