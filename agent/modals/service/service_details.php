...
if ($service_importance == "High") {
    $service_importance_display = "<span class='p-2 badge text-bg-danger'>$service_importance</span>";
} elseif ($service_importance == "Medium") {
    $service_importance_display = "<span class='p-2 badge text-bg-warning'>$service_importance</span>";
} elseif ($service_importance == "Low") {
    $service_importance_display = "<span class='p-2 badge text-bg-info'>$service_importance</span>";
} else {
...
<div class="modal-header bg-dark">
    <h5 class="modal-title text-white"><i class="fa fa-fw fa-stream me-2"></i><?php echo $service_name; ?></h5>
