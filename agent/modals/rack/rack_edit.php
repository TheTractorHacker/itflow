...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-server me-2"></i>Editing rack: <strong><?php echo $rack_name; ?></strong></h5>
...
<form action="post.php" method="post" enctype="multipart/form-data" autocomplete="off">
    ...
    <div class="modal-body">
        ...
        <ul class="nav nav-pills nav-justified mb-3">
            <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="pill" href="#pills-rack-details<?php echo $rack_id; ?>">Details</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="pill" href="#pills-rack-notes<?php echo $rack_id; ?>">Notes</a>
            </li>
        </ul>
    ...
    <div class="modal-footer">
        <button type="submit" name="edit_rack" class="btn btn-primary text-bold"><i class="fa fa-check me-2"></i>Save</button>
