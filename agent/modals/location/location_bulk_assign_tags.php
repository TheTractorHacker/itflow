...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-tags me-2"></i>Assign Tags to <strong><?= $count ?></strong> Locations</h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="bulk_assign_location_tags" class="btn btn-primary text-bold"><i class="fas fa-check me-2"></i>Assign Tags</button>
