...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fa fa-fw fa-building me-2"></i>Link Vendor to <strong><?= $document_name ?></strong></h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="link_vendor_to_document" class="btn btn-primary text-bold"><i class="fa fa-check me-2"></i>Link Vendor</button>
