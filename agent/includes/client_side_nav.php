                        ...
                        <a href="/agent/tickets.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "tickets.php" || basename($_SERVER["PHP_SELF"]) == "ticket.php") { echo "active"; } ?>">
                            ...
                            <p>
                                ...
                                if ($num_active_tickets > 0) { ?>
                                    <span class="right badge <?php if ($num_active_tickets > 0) { ?> text-bg-danger <?php } ?> text-light"><?php echo $num_active_tickets; ?></span>
                                <?php } ?>
                        ...
                        <li class="nav-item">
                            <a href="/agent/software.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "software.php") { echo "active"; } ?>">
                                ...
                                <p>
                                    ...
                                    <?php
                                    if ($num_software > 0) { ?>
                                        <span class="right badge <?php if ($num_software_expiring > 0) { ?> text-bg-warning text-dark <?php } ?> <?php if ($num_software_expired > 0) { ?> text-bg-danger <?php } ?> text-white"><?php echo $num_software; ?></span>
                                    <?php } ?>
                                </p>
                            </a>
                        </li>
                            ...
                            <a href="/agent/certificates.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "certificates.php") { echo "active"; } ?>">
                                ...
                                <p>
                                    ...
                                    if ($num_certificates > 0) { ?>
                                        <span class="right badge <?php if ($num_certificates_expiring > 0) { ?> text-bg-warning text-dark <?php } ?> <?php if ($num_certificates_expired > 0) { ?> text-bg-danger <?php } ?> text-white"><?php echo $num_certificates; ?></span>
                                    <?php } ?>
                                </p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="/agent/domains.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "domains.php") { echo "active"; } ?>">
                                ...
                                <p>
                                    ...
                                    <?php
                                    if ($num_domains > 0) { ?>
                                        <span class="right badge <?php if (isset($num_domains_expiring)) { ?> text-bg-warning text-dark<?php } ?> <?php if (isset($num_domains_expired)) { ?> text-bg-danger <?php } ?> text-white"><?php echo $num_domains; ?></span>
                                    <?php } ?>
                                </p>
                            </a>
                        </li>
                    ...
                    <li class="nav-item">
                        <a href="/agent/contracts.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "contracts.php") { echo "active"; } ?>">
                            ...
                            <p>
                                ...
                                if ($num_contracts > 0) { ?>
                                    <span class="right badge <?php if ($num_contracts_due > 0) { ?> text-bg-warning text-dark <?php } else { ?> text-light <?php } ?>"><?php echo $num_contracts; ?></span>
                                <?php } ?>
                            </p>
                        </a>
                    </li>
                        ...
                        <li class="nav-item">
                            <a href="/agent/invoices.php?client_id=<?php echo $client_id; ?>" class="nav-link <?php if (basename($_SERVER["PHP_SELF"]) == "invoices.php" || basename($_SERVER["PHP_SELF"]) == "invoice.php") { echo "active"; } ?>">
                                ...
                                <p>
                                    ...
                                    <?php
                                    if ($num_invoices > 0) { ?>
                                        <span class="right badge <?php if ($num_invoices_open > 0) { ?> text-bg-danger <?php } ?> text-light"><?php echo $num_invoices; ?></span>
                                    <?php } ?>
                                </p>
                            </a>
                        </li>
