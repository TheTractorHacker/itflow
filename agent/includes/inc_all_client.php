...
if (isset($_GET['client_id'])) {
    ...
    if (mysqli_num_rows($sql) == 0) {
        ...
        while ($row = mysqli_fetch_assoc($sql_client_tags)) {
            ...
            $client_tag_name_display_array[] = "<span class='badge " . tagTextClass($client_tag_color) . " p-1 me-1' style='background-color: $client_tag_color;'><i class='fa fa-fw fa-$client_tag_icon me-2'></i>$client_tag_name</span>";
        }
