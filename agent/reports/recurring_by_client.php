            ...
            <table class="table table-striped table-sm">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="text-end"><?php echo numfmt_format_currency($currency_format, $recurring_monthly_total, $session_company_currency); ?></td>
                    </tr>
                    <?php
                }
                ...
                ?>
                    <tr>
                        ...
                        <th class="text-end"><?php echo numfmt_format_currency($currency_format, $recurring_total, $session_company_currency); ?></th>
                    </tr>
                </tbody>
            </table>
        </div>
