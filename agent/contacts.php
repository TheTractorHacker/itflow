            ...
            <div class="table-responsive">
                <table class="table border">
                    ...
                    while ($row = mysqli_fetch_assoc($sql)) {
                        ...
                        if ($contact_user_id) {
                            $user_exists_display = "<span class='badge badge-pill badge-info p-1' title='User: $auth_method'><i class='fas fa-fw fa-user'></i></span>";
                        } else {
                            $user_exists_display = "";
                        }
                        ...
                        $asset_count = $row['num'];
                        if ($asset_count) {
                            $asset_count_display = "<a href='contact_details.php?client_id=$client_id&contact_id=$contact_id#assets' class='mr-2 mb-1 badge badge-pill badge-primary p-2' title='Assets ($asset_count)'><i class='fas fa-fw fa-desktop mr-2'></i>$asset_count</a>";
                        } else {
                            $asset_count_display = '';
                        }
                        ...
                        if ($credential_count) {
                            $credential_count_display = "<a href='contact_details.php?client_id=$client_id&contact_id=$contact_id#credentials' class='mr-2 mb-1 badge badge-pill badge-warning p-2' title='Credentials ($credential_count)'><i class='fas fa-fw fa-key mr-2'></i>$credential_count</a>";
                        } else {
                        ...
                        if ($software_count) {
                            $software_count_display = "<a href='contact_details.php?client_id=$client_id&contact_id=$contact_id#software' class='mr-2 mb-1 badge badge-pill badge-info p-2' title='Licenses ($software_count)'><i class='fas fa-fw fa-cube mr-2'></i>$software_count</a>";
                        } else {
                        ...
                        if ($ticket_count) {
                            $ticket_count_display = "<a href='contact_details.php?client_id=$client_id&contact_id=$contact_id#tickets' class='mr-2 mb-1 badge badge-pill badge-danger p-2' title='Tickets ($ticket_count)'><i class='fas fa-fw fa-life-ring mr-2'></i>$ticket_count</a>";
                        } else {
