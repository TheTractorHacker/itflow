...
<div class="row mb-4">
    <div class="col-5">
        <h3><i class="fas fa-fw fa-file-invoice-dollar me-2"></i>Unpaid Invoices</h3>
    </div>
    <div class="col-5">
        <?php if ($payment_provider_active && $bulk_payment_enabled) { // Currently not implmented fully ?>
        <button type="button" class="btn btn-outline-success dropdown-toggle float-end" data-bs-toggle="dropdown"><i class="fa fa-fw fa-credit-card me-2"></i>Pay Balance <strong>(<?php echo numfmt_format_currency($currency_format, $balance, $session_company_currency); ?>)</strong></button>
                        ...
                        <div class="dropdown-menu">
                            ...
                            while ($row = mysqli_fetch_assoc($sql_saved_payment_methods)) {
                                ...
                                <a class="dropdown-item confirm-link"
                                    ...
                                    <i class="<?php echo $payment_icon; ?> text-secondary me-2"></i><?= $saved_payment_description ?>
                                </a>
                            <?php }
                            } ?>
                        </div>
