...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fas fa-fw fa-user-plus mr-2"></i>Editing Onboarding Template: <strong><?php echo $project_template_name; ?></strong></h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-body">
        <div class="form-group">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" name="name" placeholder="e.g. Client Onboarding" maxlength="255" value="<?php echo $project_template_name; ?>" required autofocus>
            </div>
        </div>
    ...
    <div class="modal-footer">
        <button type="submit" name="edit_onboarding_template" class="btn btn-primary text-bold"><i class="fas fa-check mr-2"></i>Save</button>
