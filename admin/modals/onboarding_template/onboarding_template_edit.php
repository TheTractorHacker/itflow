...
<div class="modal-header bg-dark">
    <h5 class="modal-title"><i class="fas fa-fw fa-user-plus me-2"></i>Editing Onboarding Template: <strong><?php echo $project_template_name; ?></strong></h5>
...
<form action="post.php" method="post" autocomplete="off">
    ...
    <div class="modal-footer">
        <button type="submit" name="edit_onboarding_template" class="btn btn-primary text-bold"><i class="fas fa-check me-2"></i>Save</button>
