...
?>
    ...
    <div class="card card-dark">
        <div class="card-header py-2">
            <h3 class="card-title mt-2"><i class="fa fa-fw fa-th-list me-2"></i><?php echo nullable_htmlentities($table); ?> Fields</h3>
            ...
            <div class="table-responsive-sm">
                <table class="table table-striped table-borderless table-hover">
                    ...
                    while ($row = mysqli_fetch_assoc($sql)) {
                        ...
                        ?>
                        <tr>
                            <td><a class="text-dark" href="#" data-bs-toggle="modal" data-bs-target="#editCustomFieldModal<?php echo $custom_field_id; ?>"><?php echo $custom_field_label; ?></a></td>
                            ...
                            <td>
                                <div class="dropdown dropleft text-center">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#editCustomFieldModal<?php echo $custom_field_id; ?>">
                                            <i class="fas fa-fw fa-edit me-2"></i>Edit
                                        </a>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item text-danger text-bold confirm-link" href="post.php?delete_custom_field=<?php echo $custom_field_id; ?>&csrf_token=<?php echo urlencode($_SESSION['csrf_token']); ?>">
