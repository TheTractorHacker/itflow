                    ...
                    <tr>
                        <th>
                            <a class="text-dark ajax-modal" href="#"
                                ...
                                <i class="fa fa-fw fa-building text-secondary me-2"></i><?php echo $vendor_template_name; ?>
                            </a>
                            <?php
                        ...
                        <td>
                            ...
                            if (!empty($vendor_template_contact_name)) {
                                ?>
                                <i class="fa fa-fw fa-user text-secondary me-2 mb-2"></i><?php echo $vendor_template_contact_name_display; ?>
                                <br>
                                <?php
                            } else {
                            ...
                            if (!empty($vendor_template_phone)) { ?>
                                <i class="fa fa-fw fa-phone text-secondary me-2 mb-2"></i><?php echo $vendor_template_phone; ?>
                                <br>
                            <?php }

                            if (!empty($vendor_template_email)) { ?>
                                <i class="fa fa-fw fa-envelope text-secondary me-2 mb-2"></i><?php echo $vendor_template_email; ?>
                                <br>
                            <?php } ?>
